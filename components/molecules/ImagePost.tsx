            ...
            <View style={styles.content}>
                <Pressable style={styles.userSection} onPress={() => router.push("/user/1")}>
                    ...
                    <View style={styles.userInfo}>
                        <Text style={styles.userName}>Benny Vázquez</Text>
                        <Text style={styles.studyField}>Sistemas de Información Administrativa</Text>
                    </View>
                </Pressable>
                <View style={styles.postTextContainer}>
                    <Text style={styles.postText}>
                        El dia de hoy tendremos un nuevo taller en el
                        auditorio A-103, habrá UDPS ✨
                    </Text>
                </View>
